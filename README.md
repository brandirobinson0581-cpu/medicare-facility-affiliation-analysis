...
- The file contains 2,254,034 affiliation records representing 940,577 unique NPIs and 40,964 unique nonmissing facility certification numbers.
...
- On the held-out test set, the model achieves 85.6% accuracy, 53.4% precision, 83.0% recall, a 65.0% F1 score, and 0.948 ROC AUC. Accuracy is only 1.7 percentage points above the 83.9% majority-class baseline, which is why the additional metrics and limitations are necessary.
